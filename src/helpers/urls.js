...
export const APIUrls = {
  ...
  userFollow: (followerId, followingId) =>
    `${API_ROOT}/connection/follow/${followerId}/${followingId}`,
  userUnfollow: (followerId, followingId) =>
    `${API_ROOT}/connection/unfollow/${followerId}/${followingId}`,
  createPost: () => `${API_ROOT}/post/create`,
  deletePost: (id) => `${API_ROOT}/post/delete/${id}`,
  projectList: (id) => `${API_ROOT}/project/my/${id}`,
  classList: (id) => `${API_ROOT}/class/my/${id}`,
